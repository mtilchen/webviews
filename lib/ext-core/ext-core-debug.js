...
(function(){
    ...
    Ext.apply(EXTLIB.Easing, {
        ...
        easeConstant: function(t, b, c, d) {
          return b + c; /* Always return 'to' value where b == from and c == to -from */
        },
        ...
        bezierQuad: function(t, from, to, ctrl) {
          return pow(1-t, 2) * from + 2 * (1-t) * t * ctrl + pow(t, 2) * to;
        }
    });
})();
